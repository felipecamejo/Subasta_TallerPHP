...
export const routes: Routes = [
  ...
  {
    path: 'admin/aprobar-casas',
    loadComponent: () => import('./admin/aprobar-casas/aprobar-casas.component').then(m => m.AdminAprobarCasasComponent)
  },
  {
    path: 'admin/desaprobar-casas',
    loadComponent: () => import('./admin/desaprobar-casas/desaprobar-casas.component').then(m => m.DesaprobarCasasComponent)
  },
  {
    path: 'admin/usuarios',
  ...
  {
    path: 'dashboard-rematador',
    component: DashboardRematadorComponent,
    canActivate: [RoleGuard],
    data: { roles: ['rematador'] }
  },
  {
    path: 'dashboard-casa-remate',
    component: CasaRemateDashboardComponent,
    canActivate: [RoleGuard],
    data: { roles: ['casa_remate'] }
  },
  {
    path: 'admin',
  ...
  {
    path: 'login-google',
    loadComponent: () => import('./login-google/login-google.component').then(m => m.LoginGoogleComponent)
  },
